...
def train1key( 
    ...
    # os.system(f"cp -r assets/weights/yuhui.pth assets/weights/{exp_dir1}.pth")
    ...
    os.system("mv logs/{}/add* logs/".format(exp_dir1))
...
class GradioInfer:
    ...
    def run(self):
        ...
        iface.queue(concurrency_count=511, max_size=1022).launch(share=True, server_name="10.21.226.169",server_port=8913)
